...
def PredictResult(file_path):
    ...
    lists1 = glob(filesPath)
    lists1.sort()
    lists1 = lists1[20:-15]  # 去除前10張和後3張
    ...
    for i in range(0, len(lists1), split):
        ...
        localpath = "D:\\jupyter\\Chinese Vocab LipReading\\system\\django_system_client_only_predict\\PredictData\\" + str(theTime) + "\\" + str(num) + ".npy"
        filepath = "/home/eagleuser/Users/dragon/Chinese_vocab_LipReading/test/predict_data/" + str(
            theTime) + "/" + str(num) + ".npy"
        sftp.put(localpath, filepath)  # upload 檔案
